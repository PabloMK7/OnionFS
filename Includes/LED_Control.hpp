...
namespace CTRPluginFramework {
	...
	class LED {
		...
		public:
			...
			static RGBLedPattern GeneratePattern(Color color, LED_PatType type, Time delay_time, Time loop_delay, u8 smooth = 0, float r_shift = 0, float g_shift = 0, float b_shift = 0);
	};
}
