...
run("rm obj/*.o")
run("rm bin/*.elf")
run(CC+  " -s  -g -I include -I include/libntrplg " + allFile('source/*.c') + allFile('source/libntrplg/*.c') + allFile('source/ns/*.c') + allFile('source/libctru/*.c') + " -c  -march=armv6 -mlittle-endian  ");
